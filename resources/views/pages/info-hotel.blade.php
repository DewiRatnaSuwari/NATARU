...
<h2 class="text-center fw-bold mb-5" style="font-size: 2.5rem; color:rgb(212, 138, 53);">
   HOTEL&RESTAURANT
    ...
    <div class="row justify-content-center g-4">
        @php
            $menus = [
                ['title' => 'Hotel', 'image' => 'Hotel.png', 'color' => 'text-danger', 'btn' => 'btn-primary'],
                ['title' => 'Restoran', 'image' => 'restoran.png', 'color' => 'text-info', 'btn' => 'btn-info'],
            ];
        @endphp
    ...
    $link = match($menu['title']) {
        'Hotel' => 'https://infomudik.semarangkota.go.id/halaman/daftar/1',
        'Restoran' => 'https://infomudik.semarangkota.go.id/halaman/daftar/2',
    };
@endphp
